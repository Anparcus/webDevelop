                                            ...
                                            <?php foreach ($eventos_dias as $dia => $eventos) { ?>
                                                <div id="<?php echo str_replace('á', 'a', $dia); ?>" class="contenido-dia clearfix row">
                                                    ...
                                                    <?php foreach ($eventos['eventos'] as $tipo => $evento_dia) : ?>
                                                        <div class="icheck-success d-inline col-md-4">
                                                            <p><?php echo $tipo; ?></p>
                                            ...
                                            <div class="caja clearfix row">
                                                <div class="extras col-md-6">
                                                    <div class="orden">
                                                        ...
                                                        <input type="number" class="form-control" min="0" id="camisa_evento" name="pedido_extra[camisa][cantidad]" size="3" placeholder="0">
