...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Llena o edita el formulario para actualizar un usuario registrado</small>
        </h1>
    </section>
    <div class="row">
        <div class="col-md-8">
                        ...
                        <form class="editar-registrado" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-registrado.php">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo $registrado['email_registrado']; ?>">
                                </div>
                                <?php
                                ...
                                <div class="form-group">
                                    <div id="paquetes" class="paquetes">
                                        ...
                                        <ul class="lista-precios clearfix row">
                                            ...
                                            <li>
                                                <div class="tabla-precio text-center">
                                                    <h3>Pase por dos días (Viernes y Sabado)</h3>
                                                    <p class="numero">45€</p>
                                                    <ul>
                                                        <li><i class="fas fa-check check"></i>Bocadillos Gratis</li>
                                                        <li><i class="fas fa-check check"></i>Todos las Conferencias</li>
                                        ...
                                        <div id="resumen" class="resumen clearfix">
                                            ...
                                            <div class="caja clearfix row">
                                                <div class="extras col-md-6">
                                                    <div class="orden">
                                                        <label for="camisa_evento">Camisa Evento 10€ <small>(Promoción 7% de Dto.)</small></label>
                                                        <input value="<?php echo $boletos['camisas']; ?>" type="number" class="form-control" min="0" id="camisa_evento" name="pedido_extra[camisa][cantidad]" size="3" placeholder="0">
                                                        <input type="hidden" value="10" name="pedido_extra[camisa][precio]">
                                                    </div>
                                                    <!--.orden-->
                                                    <div class="orden">
                                                        <label for="etiquetas">Paquete de 10 etiquetas 2€ <small>(HTML5, JavaScript, Chrome)</small></label>
