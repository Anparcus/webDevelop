      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="crear-invitado.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>Agregar Invitado</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="crear-registro.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>Registrar Nuevo</a></li>
          </ul>
        </li>
        <?php if ($_SESSION['nivel'] == 1) { ?>
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="crear-admin.php"><i class="fa fa-plus-circle" aria-hidden="true"></i>Agregar Administrador</a></li>
            </ul>
          </li>
        <?php }; ?>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-plus-circle" aria-hidden="true"></i>Agregar Testimonial</a></li>
          </ul>
        </li>
