                            ...
                            <tbody>
                                ...
                                while ($invitado = $resultado->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><img src="../img/invitados/<?php echo $invitado['url_imagen'] ?>" width="30%"><br><?php echo $invitado['url_imagen']; ?></td>
                                        <td>
                                ...
                                //Comprovamos que nos llegue la informacion requerida, solo nos aporta un dato por que tenemos que recorrerlo e imprimisrlo
                                //echo("<pre>");
                                //var_dump($admin);
                                //echo("</pre>");
                                ?>
