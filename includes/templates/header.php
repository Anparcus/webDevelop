...
<head>
	...
	<title>Desarrollador y Diseñador Web Freelance</title>
	<meta name="description" content="programador web, desarrollador de aplicaciones web, freelance programador, programador wordpress, desarrollador de aplicaciones web">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta property="og:title" content="Andres López · Diseñador web freelance">
	<meta property="og:description" content="Más de 5 años trabajando en exclusiva como diseñador web freelance. Ofrezco soluciones tecnológicas a empresas y profesionales interesados en crear su imagen digital, para conectar con sus usuarios, nos adaptamos a tu presupuesto.">
	<meta property="og:url" content="https://webdevelop.dev/">
	<meta property="og:site_name" content="Andres López Diseñador web freelance">
	<meta property="og:image" content="https://webdebelop.web">
...
<body class="<?php echo $pagina; ?>">
	...
	<div id="dragon_icon">
		<a href="#" class="buttonHeader">
			<img class="dragon_icon" src="img/dragon.png">
			<img class="prohibido" src="img/prohibido.png">
		</a>
	</div>
	...
	<header class="site-header">
		...
		<div class="hero">
			...
			<div class="contenido-header">
				<div class="fecha">
					<p class="fecha"><i class="fas fa-calendar-alt"></i><?php echo date(' d/m/Y'); ?></p>
				</div>
				...
				<!--nav-redes-sociales-->
				<div class="ciudad">
					<p class="ciudad"><i class="fas fa-map-marker-alt"></i> Manresa, ES</p>
				</div>
				<!--ciudad-->
				<div class="andreslogo">
					<img src="img/andreslogo.svg" alt="logo">
				</div>
				<!--logo-->
				<div class="enlaces_img">
					<div class="cohete">
						<img src="img/cohete.png" alt="browsers">
					</div>
					<div class="diagrama_web">
						<img src="img/diagrama_web.png" alt="diagrama web">
					</div>
					<div class="user_pc_icons">
						<img src="img/img_user_pc_icons.png" alt="pc icons">
					</div>
				</div>
				<!--enlaces_img-->
				<div class="informacion-evento">
					<h1 class="nombre-sitio">Web Developer</h1>
					<p class="slogan1">Creación y diseño</p>
					<p class="slogan">de paginas Web y Apps... <span>&#160;</span> </p>
				</div>
				<!--informacion-evento-->
	...
	<div class="barra">
		<div class="contenedor clearfix">
			<div class="logo">
				<a href="index.php">
					<img src="img/logo.svg" alt="logo desarrollador web">
				</a>
			</div>
